			...
			<div class="row">
				<div class="col-md-12">
						...
						<hr>
							<div class="portlet-body">
							 <table width="40%" align="center">
								<tbody>
								   <?php 
									   $pension_personal=$pension_company=$pension_total=0;
									  $pensions   =   $this->db->select('*')->from('employees')->join('salaries','employees.employee_id=salaries.employee_id')
													  ->where('employees.employee_id',$employee_id)
													  ->order_by('year','DESC')
													  ->get()->result_array();
									  foreach($pensions as $row):
										$pension_personal +=$row['pension_personal'];
										$pension_company +=$row['pension_company'];
										$pension_total +=$row['pension_total'];
																  
										?>
							<tr>
							 <td colspan="2"><b><?php echo $row['salary_date'];?></b></td>
						   </tr>
						
						
						   <tr>
							<td>Gloss Salary</td>
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['gloss_salary'])),2);?></td>
						   </tr>
							<tr>
							<td>Net Salary</td>
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['net_salary'])),2);?></td>
						   </tr>
							...
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['pension_company'])),2);?></td>
						   </tr>
						   
						   <tr>
							<td>Total Pension</td>
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['pension_total'])),2);?></td>
						   </tr>
						   
						   <tr>
							<td>GLA</td>
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['gla'])),2);?></td>
						   </tr>
						   
						   <tr>
							<td>Broker</td>
							<td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['broker'])),2);?></td>
						   </tr>
                  ...
                  <?php endforeach;?>
					...
					<td><b>Staff Contribution</b></td>
                    <td><b>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$pension_personal)),2);?></b></td>
                   </tr>
                   <td><b>Company Contribution</td>
                      <td><b>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$pension_company)),2);?></b></td>
                   </tr>
                   <td><b>Total Pension : </i></td>
                    <td><b>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$pension_total)),2);?></b></td>
                   </tr>
                </tbody>
					</table>
