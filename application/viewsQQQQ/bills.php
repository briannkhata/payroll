						...
						<div class="portlet-body">
						 ...
						 <?php  foreach($bill as $row):?>
							<tr class="odd gradeX">
							 ...
							 <td align="center" >
							 	<a href="<?=base_url();?>admin/receipt_preview/<?=$row['client_id'];?>" class="btn default btn-xs blue-stripe"> RECEIPT PREVIEW</a>
						     </td>
							</tr>
						  <?php endforeach;?>
...
<!-- END BODY -->
			...
			<div class="modal fade" id="client" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
				<div class="modal-dialog">
					<div class="modal-content" style="min-height:649px;width:130%;">
					...
					<div class="col-md-6">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="visit_date" id="d2" placeholder="Visit Date" required>
						</div>
					</div>
