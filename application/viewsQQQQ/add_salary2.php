												...
												<div class="row">													
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
															    <input type="hidden" name="employee_id" class="form-control" value="<?=$employee_id;?>" readonly>
																<input type="text" name="" class="form-control" value="<?=$this->db->get_where('employees',array('employee_id'=>$employee_id))->row()->name;?>" readonly>
															</div>
														</div>
													</div>
												</div>												
