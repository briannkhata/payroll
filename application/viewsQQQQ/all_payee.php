		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
					<?php 
					$net_salary=$gloss_salary=$payeee=0;
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td>PAYEE</td>
                      <td>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['payee'])),2);?></td>
                   </tr>
               
                  <?php endforeach;?>
                    <td><i>Total PAYEE</i></td>
                      <td><i>MWK : <?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$payeee)),2);?></i></td>
                   </tr>
                </tbody>
					</table>
