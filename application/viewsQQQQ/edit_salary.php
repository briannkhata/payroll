				...
				<div class="col-md-12">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<?=$page_title;?> | <?=$month;?> | <?=$year;?></span>
									
								</div>
								<div class="actions btn-set"></div>
									<?php if ($this->session->flashdata('message')) { ?>
										<div class="alert alert-info fade in" style="margin-top:4%;">
							...
							<hr>		
							<?php //$ammend = $this->db->get_where('salaries',array('employee_id'=>$employee_id,'month'=>$month,'year'=>$year))->result_array();?>
							<?php //foreach($ammend as $row0):?>
							<?php //$name = $this->db->get_where('employees',array('employee_id'=>employee_id']))->row()->name;?>
									<div class="portlet-body">
										<form action="<?=base_url();?>salary/update_salary" method="post" class="form-horizontal">
											<div class="form-body">
												...
												<div class="row">													
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
															  <!--input type="hidden" name="salary_id" class="form-control" id="inputEmail3" value="<?=$salary_id;?>"-->
															  <!--input type="text" name="employee_id" class="form-control" id="inputEmail3" value="<?=$employee_id;?>"-->
															 <!--input type="text" class="form-control" value="<?=$this->db->get_where('employees',array('employee_id'=>$employee_id))->row()->name;?>" readonly-->
																<select class="form-control see" name="employee_id" style="min-width:34%;">
																	<option  selected disabled value="">Staff</option>
																	<?php $dd=$this->db->get_where('employees',array('active'=>1))->result_array();?>
																	<?php foreach($dd as $sel):?>
																    <option value="<?=$sel['employee_id'];?>"><?=$sel['name'];?></option>
																	<?php endforeach;?>
																</select>
															</div>
														</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
															   <input type="text" name="month" class="form-control" value="<?=$month;?>" readonly>
															</div>
														</div>
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="row">
															<div class="col-md-offset-3 col-md-9">
																...
																<a href="<?=base_url();?>admin/salary_list" class="btn default blue"><i class="fa fa-cancel"></i> << back</a>
															</div>
														</div>
													</div>
