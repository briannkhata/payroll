						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button id="sample_editable_1_new" class="btn green" onclick="add_test_parameta();">
						...
						<?php  foreach($test_p as $row):?>
							<tr class="odd gradeX">
							 ...
							 <td><?=$row['test_parameter'];?></td>
							  ...
							  <td align="center" >
								<a href="javascript:;" class="btn default btn-xs purple" onclick="edit_test_parameter(<?=$row['test_parameter_id'];?>)"><i class="fa fa-edit"></i> Edit </a>
								<a href="javascript:;" class="btn default btn-xs black" onclick="delete_test_parameter(<?=$row['test_parameter_id'];?>)"><i class="fa fa-trash-o"></i> Delete </a>				
							</td>
							</tr>
							<?php endforeach;?>
...
<script type="text/javascript">
   var save_method; //for save method string
    var table;
	function add_test_parameta()
    {
      var url="<?=base_url();?>admin/add_test_parameter";
      location.href=url;
    }
    ...
    {
      save_method = 'add';
      $('#formparameter')[0].reset(); // reset form on modals
      $('#test_parameter').modal('show'); // show bootstrap modal
    }
    function edit_test_parameter(id)
    {
      save_method = 'update';
      $('#formparameter')[0].reset(); // reset form on modals
      ...
      $.ajax({
        url : "<?php echo site_url('admin/test_parameter_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			$('[name="test_parameter_id"]').val(data.test_parameter_id);
			$('[name="test_id"]').val(data.test_id);
            $('[name="test_parameter"]').val(data.test_parameter);
            $('[name="parameter_category"]').val(data.parameter_category);

            $('#test_parameter').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Test Parameter'); // Set title to Bootstrap modal title
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('admin/test_parameter_add')?>";
      }
      else
      {
        url = "<?php echo site_url('admin/test_parameter_update')?>";
      }
    ...
    function delete_test_paramter(id)
    {
...
$(document).ready(function(){
    ...
    $(wrapper).on('click', '.remove_button', function(e){ //Once remove button is clicked
        ...
        x--; //Decrement field counter
			...
			<div id="test_parameter" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
			  <div class="modal-dialog">
				<div class="modal-content" style="min-height:auto;">
				  <div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title"> ADD TEST PARAMETERS</h4>
				  </div>
				  <div class="modal-body">
				  <div class="box box-primary">
					<form role="form" action="#" id="formparameter" style="min-height:50px;>
					  <div class="box-body">
					  
					  <div class="col-md-6">
						<div class="form-group">
						  <label for="exampleInputEmail1">Test Name</label>
						   <input type="hidden" name="test_parameter_id" value="">
					...
					<div class="col-md-12">
						<div class="form-group">
						  <label for="exampleInputEmail1">Parameter Category</label>
				 		  <input type="text" class="form-control" name="parameter_category" id="exampleInputEmail1" placeholder="Parameter Category" required>
						</div>
					</div>
					<div class="field_wrapper">
						 <div class="col-md-12">
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="test_parameter[]" id="exampleInputEmail1" placeholder="Test Parameter" required>
					...
					<div class="col-md-12">
						<div class="form-group">
							<div class="modal-footer">
								 <button type="button" class="btn blue zanda" onclick="save()">Add Parameters</button>
