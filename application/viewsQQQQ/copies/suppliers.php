					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button id="sample_editable_1_new" class="btn green" onclick="add_supplier();">
							...
							<table class="table table-striped table-bordered table-hover" id="nyani">
							<thead>
							<tr>
						...
						<?php  foreach($supplier as $row):?>
							<tr class="odd gradeX">
							 ...
							 <td><?=$row['email'];?></td>
							 <td align="center" >
								<a href="javascript:;" class="btn default btn-xs purple" onclick="edit_supplier(<?=$row['supplier_id'];?>)"><i class="fa fa-edit"></i> Edit </a>
								<a href="javascript:;" class="btn default btn-xs black" onclick="delete_supplier(<?=$row['supplier_id'];?>)"><i class="fa fa-trash-o"></i> Delete </a>				
							</td>
							</tr>
							<?php endforeach;?>
	...
	<script>
		...
		$(window).on('resize', function () {
		  if ($(window).width() <= 767) $('#sidebar-collapse').collapse('hide')
			...
			<div id="supplier" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
