			...
			<div class="row">
				<div class="col-md-12">
					<div class="portlet light">
							...
							<?php $name= $this->db->get_where('clients',array('client_id'=>$client_id))->row()->name;?>
													...
													<div class="portlet-body">
														<p></p>
																<form action="<?=base_url();?>admin/addbill" method="post" id="fomu">
																		...
																		<div class="form-group">
																			<div class="input-group margin-top-10">
																				<span class="input-group-addon">Total Bill</span>
																				 <input type="hidden" name="client_id" class="form-control input-lg" value="<?=$client_id;?>">
																			
																				   <input type="text" name="total_bill" id="total_bill" class="form-control input-lg" value="<?=$room_price;?>" readonly>
																	...
																	<div class="col-md-6">
																		<div class="form-group">
																			<label>Amount Tendered</label>
																			 <input type="text" name="amount_tendered" id="amount_tendered" class="form-control input-lg" placeholder="Amount Tendered" required>
																		</div>		
																	</div>	
																	...
																	<div class="col-md-12">
																		<div class="form-group">
																			<button type="submit"  class="btn blue"><i class="fa fa-save"></i> save bill</button>
																		</div>
																	</div>
																</form>
