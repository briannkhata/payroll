												...
												<div class="portlet-body">
														...
														$bill   =   $this->db->select('*')
															...
															<tr class="odd gradeX">
															 ...
															 <td><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['amount'])),2);?></td>
															 <td align="center" class="nop">					
																<a href="javascript:;" class="btn btn-info btn-xs black" onclick="edit_schemebill(<?=$row['scheme_bill_id'];?>)" title="CLICK TO EDIT"><i class="fa fa-edit"></i> edit</a>				
