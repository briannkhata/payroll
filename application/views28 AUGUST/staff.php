															...
															<div class="col-md-6">
																	<a href="<?=base_url();?>admin/add_staff" id="sample_editable_1_new" class="btn green">
																		...
																		<form class="form-inline" action="<?=base_url();?>staff/filter_staff" method="post" style="width:100%; margin-left:25%;margin-top:-7%;">
																				...
																				<select class="form-control see" name="depot_id" style="min-width:34%;">
																					<option  selected disabled value="">Depot</option>
																				...
																				<select class="form-control see" name="department_id" style="min-width:30%;">
														...
														<?php  foreach($staff as $row):?>
															<tr class="odd gradeX">
															 ...
															 <td align="center" class="nop">					
																...
																<a href="<?=base_url();?>admin/staff_delete/<?=$row['employee_id'];?>" class="btn btn-danger btn-xs black" title="CLICK TO DELETE"><i class="fa fa-trash-o"></i> delete</a>				
															</td>
															</tr>
															<?php endforeach;?>
										...
										<div class="tab-pane" id="tab_images">	
													...
													<div class="table-toolbar">
														...
														<table class="table table-striped table-bordered table-hover" id="mm">
															...
															<tbody>
														<?php  $count=1;
														$tr =$this->db->select('*')->from('employees')->where('active',0)->get()->result_array();?>
														<?php  foreach($tr as $row):?>
															 ...
															 <td><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['bsalary'])),2);?></td>
															 <td align="center" class="nop">					
																<a href="<?=base_url();?>admin/activate_staff/<?=$row['employee_id'];?>" class="btn btn-success btn-xs black" title="CLICK TO DELETE"><i class="fa fa-edit"></i> ACTIVATE STAFF</a>				
															</td>
															</tr>
															<?php endforeach;?>
