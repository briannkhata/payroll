			...
			<div class="row"  id="tk">
				      <div class="col-md-12" >
							...
							<div class="btn-group pull-right" style="margin-top:-4%; margin-left:3%;">
										...
										<button id="sample_editable_1_new" class="btn green" onclick="javascript:printa();">
																  ...
																  <table class="table table-bordered pull-right" style="margin-right:40%;border-radius:3px;" id="t1">
																   <tr>
																    ...
																    <tr>
																	 ...
																	 <tr>
																		<td>Basic Salary</td><td> MWK : <?=number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['bsalary'])),2);?></td>
																	</tr>
																	 <tr>
																	   <td>Depot</td><td><?=$this->db->get_where('depot',array('depot_id'=>$row['depot_id']))->row()->depot;?></td>
																	 </tr>
																	<tr>
																		<td>Bank</td><td><?=$row['bank'];?></td>
																	</tr>
