							...
							<div class="tab-pane" id="tab_lon">	
												...
												<div class="portlet-body">
													<div class="table-toolbar">
															<div class="row">
															<div class="col-md-6">
																				<button id="sample_editable_1_new" class="btn green" onclick="add_tax();">
														...
														<table class="table table-striped table-bordered table-hover" id="m0">
															...
															<tr class="odd gradeX">
																...
																<td align="center">					
																	<a href="javascript:;" class="btn btn-info btn-xs black" onclick="edit_taxband(<?=$row['tax_config_id'];?>)"><i class="fa fa-edit"></i> edit</a>				
