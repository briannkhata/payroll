				...
				<div class="col-md-12">
							...
							<hr>															
									<div class="portlet-body">
										<form action="<?=base_url();?>salary/create_salaryy" method="post" class="form-horizontal">
											<div class="form-body">
												...
												<div class="row">													
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
															   	    <select name="employee_id" class="form-control" id="eee">
																			<?php
																			$data = [];
																			$db = $this->db->select('employee_id')->from('salaries')->where('month',date('F'))->where('year',date('Y'))->get()->result_array();
																			if(count($db) > 0)
																			{
																				foreach($db as $row)
