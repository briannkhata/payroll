					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button id="sample_editable_1_new" class="btn green" onclick="add_sub_test();">
						...
						<?php  foreach($test as $row):?>
							<tr class="odd gradeX">
							 ...
							 <td><?=$row['sub_test'];?></td>
							 <td align="center" >
								<a href="javascript:;" class="btn default btn-xs purple" onclick="edit_test(<?=$row['sub_test_id'];?>)"><i class="fa fa-edit"></i> Edit </a>
								<a href="javascript:;" class="btn default btn-xs blue-stripe" onclick="vtest(<?=$row['sub_test_id'];?>)"> View </a>
								<a href="javascript:;" class="btn default btn-xs black" onclick="delete_test(<?=$row['sub_test_id'];?>)"><i class="fa fa-trash-o"></i> Delete </a>				
							</td>
							</tr>
							<?php endforeach;?>
...
<script>
 ...
 <script type="text/javascript">
	...
	<script>
		...
		<div id="subtest" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
			  <div class="modal-dialog">
					...
					<form role="form" action="#" id="formsubtest">
					 ...
					 <div class="col-md-12">
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="sub_test" id="exampleInputEmail1" placeholder="Sub Test" required>
						</div>
					</div>
            </form>
		  </div>
		...
		<div id="vtest" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
			  <div class="modal-dialog">
