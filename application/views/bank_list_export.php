	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="page-head">
				...
				<br/> <br/>		 								
				<div class="row">
					<form class="form-inline" action="<?php echo base_url();?>admin/list_export" method="post" style="width:100%;">
							
						<div class="col-md-4">	
							<select class="form-control see" name="month" style="width:100%;">
								<option  value="">Month</option>
								<?php $y = date('F'); $dd=$this->db->get('month')->result_array();?>
						...
						<div class="col-md-4">	
							<select class="form-control see" name="year" style="width:100%;">
								<option  value="">Year</option>
								<?php $y = date('Y');
								 $dd=$this->db->get('year')->result_array();?>
								<?php foreach($dd as $sel):?>
									<option value="<?=$sel['year'];?>"><?=$sel['year'];?></option>
								<?php endforeach;?>
							</select>
						</div>
						
						<div class="col-md-3">
								<button type="submit" class="btn btn-search"><i class="fa fa-search"></i> Export to Excel</button>
						</div>
					</form>
				</div>
					<br/> <p style="font-size:15px;"><center> <b>  Select month and year then click "export" to export files to excell </b>	 </p>								
			</div>
