...
<?php include 'includes/left_nav.php';?>
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="portlet-body">
				<form role="form" action="<?php echo base_url();?>salary/pp_add" method="post">
						...
						<div class="form-group">
						  <label for="exampleInputEmail1"></label>
							<div class="radio-list">
								<?php $pp = $this->db->get('pension_para',array('deleted' =>0))->result_array();
								if(count($pp) > 0){?>
				  ...
				  <div class="col-md-3">
					...
					<div class="modal-footer" style="border: none;">
						<a href="<?php echo base_url();?>salary/add_pension_para1" class="btn btn-default"><< Back</a>
