													...
													<div class="table-toolbar">
																		...
																		<div class="btn-group">
																			<form class="form-inline" action="<?=base_url();?>staff/filter_payee" method="post">
																				...
																				<select class="form-control" name="year" id="s3">
																					...
																					<?php 
																					 $y = date('Y');
																					$year=$this->db->get('year')->result_array();?>
																					<?php foreach($year as $cel):?>
																						<option value="<?=$cel['year'];?>"  <?php if($y == $cel['year']) {echo 'selected';}?>>
																							<?=$cel['year'];?>
																						</option>
																					<?php endforeach;?>
																				</select>
																				<button type="submit" class="btn btn-search"><i class="fa fa-search"></i>View Payee</button>
																			</form>
																		</div>
																	</div>
																<div class="col-md-3">
																	<div class="btn-group pull-right">
																		<button class="btn btn-sucess blue" onclick="window.print();" id="po">print <i class="fa fa-print"></i>
																		</button>
																	</div>
																</div>
															</div>
														...
														<table class="table table-striped table-bordered table-hover" id="m0">
															...
															<tr class="odd gradeX">
																...
																<td><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['net_salary'])),2);?></td>
																<td><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['payee'])),2);?></td>
																<td><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$row['gloss_salary'])),2);?></td>
           														<td align="center" class="nop">	          
																	<!--a href="<?=base_url();?>staff/view_payee/<?=$row['salary_id'];?>" class="btn btn-success btn-xs blue"><i class="fa fa-eye"></i>view </a-->
																	<a href="<?=base_url();?>staff/all_payee/<?=$row['salary_id'];?>" class="btn btn-success btn-xs black"><i class="fa fa-info"></i> summary</a>				
																</td>
															</tr>
															<?php endforeach;?>
															</tbody>
													           <tr>
																  <td>TOTALS</td>
																  <td></td>
																  <td><b><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$net_salary)),2);?></b></td>
																  <td><b><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$payeee)),2);?></b></td>
																  <td><b><?php echo number_format(sprintf('%0.2f', preg_replace("/[^0-9.]/", "",$gloss_salary)),2);?></b></td>
																  <td class="nop"></td>
