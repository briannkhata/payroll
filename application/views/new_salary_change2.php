		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
                  ...
                  <?php } ?>  
											<form role="form" action="<?php echo base_url();?>staff/new_salary_add" method="post">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Staff</label>
                              <select name="employee_id" class="form-control" required="">
                                  <?php
                                  $data = [];
                                  $db = $this->db->select('employee_id')->from('salary_change')
                                  ->where('month',$month)
                                  ->where('year',$year)
                                  ->get()->result_array();
                                  if(count($db) > 0)
                          ...
                          <div class="form-group">
                              <div class="checkbox-list">
                               <label class="checkbox-inline">
                                <input type="checkbox" name="maintain"> Maintain Salary</label>  <h1>OR </h1>
                          </div>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for="exampleInputEmail1">New Salary</label>
                              <input type="text" class="form-control" name="salary" placeholder="New Salary">
                          </div>
                        </div>
