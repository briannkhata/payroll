			...
			<div class="row">
				<div class="col-md-12">
							...
							<div class="tab-pane" id="tab_lon">	
										...
										<div class="portlet-body">
				<?php $all = $this->db->get_where('pension_para',array('id' =>$id))->result_array();
					foreach ($all as $row) {?>
				<form role="form" action="<?php echo base_url();?>salary/pp_update" method="post">
				  <div class="col-md-6">
						<div class="form-group">
						  <label for="exampleInputEmail1">Staff</label>
						    <input type="hidden" name="id" value="<?php echo $row['id'];?>" class="form-control">
						    <input type="text" name="staff" value="<?php echo $row['staff'];?>" class="form-control">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
						  <label for="exampleInputEmail1">Broker</label>
						    <input type="text" name="broker" value="<?php echo $row['broker'];?>" class="form-control">
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
						  <label for="exampleInputEmail1">GlA</label>
							<input type="text" name="gla" value="<?php echo $row['gla'];?>" class="form-control">
						</div>
					</div>
