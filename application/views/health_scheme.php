							...
							<hr>
										<div class="portlet-body">
													<div class="table-toolbar">
																<div class="col-md-6">
																		<div class="btn-group">
																			<a href="<?php echo base_url();?>admin/add_health" id="sample_editable_1_new" class="btn green">
															...
															<tr class="odd gradeX">
																	...
																	<td><?=$row['membership_number'];?></td>
																	 <td align="center" class="nop">					
																		<a href="javascript:;" class="btn btn-info btn-xs black" onclick="edit_scheme(<?=$row['health_scheme_id'];?>)" title="CLICK TO EDIT">EDIT</a>				
																		<a href="<?php echo base_url();?>admin/view_scheme/<?php echo $row['health_scheme_id'];?>" class="btn btn-success btn-xs black" title="CLICK TO VIEW DETAILS">VIEW DETAILS</a>				
																		<a href="javascript:;" class="btn btn-warning btn-xs black" onclick="delete_scheme(<?=$row['health_scheme_id'];?>)" title="CLICK TO DELETE">DELETE</a>				
																	</td>
															</tr>
															<?php endforeach;?>
															</tbody>
...
<script type="text/javascript">
   var save_method; //for save method string
    ...
    {
      save_method = 'update';
      //$('#formschemee')[0].reset(); // reset form on modals
...
function savee()
				...
				<form role="form" action="#" id="formscheme">
				  <div class="col-md-6">
					...
					<div class="modal-footer">
						...
						<button type="button"  class="btn blue zanda" onclick="save()">Add scheme</button>
					</div>
            </form>
	    </div>
	  </div>
	...
	<div id="schemee" class="modal fade" tabindex="-1"  data-backdrop="static" data-keyboard="false"  style="border-radius:2px;">
				  <div class="modal-header">
						<h4 class="modal-title"> ADD SCHEME</h4>
				  </div>
				  <div class="modal-body">
				<form role="form" action="#" id="formschemee">
				  <div class="col-md-6">
						<div class="form-group">
						  <label for="exampleInputEmail1">Staff</label>
						   <input type="hidden" name="health_scheme_id" value="">
					...
					<div class="modal-footer">
						<button type="button" data-dismiss="modal" class="btn btn-default">Cancel</button>
						<button type="button"  class="btn blue zanda" onclick="savee()">Add scheme</button>
					</div>
            </form>
	    </div>
	  </div>
