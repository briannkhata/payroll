				...
				<div class="col-md-12">
							...
							<hr>															
									<div class="portlet-body">
										<form action="<?=base_url();?>salary/create_salary" method="post" class="form-horizontal">
											<div class="form-body">
												...
												<div class="row">													
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" name="employee_id" id="s7" required>
																<?php $e=$this->db->get_where('employees',array('active'=>1))->result_array();?>
																<?php foreach($e as $tt):?>
																	<option value="<?=$tt['employee_id'];?>"><?=$tt['name'];?></option>
																<?php endforeach;?>
																</select>
															</div>
														</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<select class="form-control" name="month" id="s1" required>
																<?php 
																$m = date('F');
																$ee=$this->db->get('month')->result_array();?>
																<?php foreach($ee as $tt):?>
																	<option value="<?=$tt['month'];?>" <?php if($m == $tt['month']){echo 'selected';}?> >
																		<?=$tt['month'];?>
																	</option>
																<?php endforeach;?>
																</select>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<select class="form-control" name="year" id="s2" required>
																<?php 
																$yr = date('Y');
																//$eee=$this->db->get('year')->result_array();?>
																<?php //foreach($eee as $tt):?>
																	<!--<option value="<?=$yr;?>" <?php// if($yr == $tt['year']){echo 'selected';}?> selected="selected">--->
																	<option value="<?=$yr;?>" selected="selected">
																		<?=$yr;?>
																	</option>
																<?php //endforeach;?>
																</select>
													...
													<div class="col-md-6">
														<div class="row">
															<div class="col-md-offset-3 col-md-9">
																<button type="submit" class="btn green"><i class="fa fa-plus"></i> add salary</button>
																<a href="<?=base_url();?>admin/salary_schedule" class="btn default blue"><i class="fa fa-cancel"></i> << back</a>
															</div>
														</div>
													</div>
