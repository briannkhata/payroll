  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <div class="page-head">
        ...
        <br/> <br/>                   
        <div class="row">
                                <form class="form-inline" action="<?=base_url();?>salary/filter_payroll" method="post" style="width:100%;">
                                      <div class="col-md-3">  
                              ...
                              <div class="col-md-3">
                                <button type="submit" class="btn btn-search"><i class="fa fa-search"></i> View Payroll</button>
                              </div>
                        </form>
        </div>
          <br/> <p style="font-size:15px;"><center> <b>  Select filters to filter payroll </b>   </p>               
      </div>
