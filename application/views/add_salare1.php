			...
			<div class="row">
				<div class="col-md-12">
							...
							<div class="tab-pane" id="tab_lon">	
								<div class="portlet-body">															
                        			<form role="form" action="<?php echo base_url();?>admin/add_salare2" method="post">
                                     <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <a href="<?php echo base_url();?>admin/salary_schedule"  class="btn btn-default"><< Back</a>
                                    <button type="submit"  class="btn blue zanda" onclick="save()"> CONTINUE >></button>
                                  </div>
                                    </form>
												</div>
										</div>
