			...
			<div class="row">
				<div class="col-md-12">
							...
							<div class="tab-pane" id="tab_lon">	
										<form action="<?=base_url();?>salary/bulk_salary" method="post">
												<div class="portlet-body">
													<div class="table-toolbar">
															<div class="row">
															<div class="col-md-6">
																		
																			<a href="<?=base_url();?>admin/add_salary" id="sample_editable_1_new" class="btn green">
																			Add New [Any Month] <i class="fa fa-plus"></i>
																			</a>
																			
																			<a href="<?=base_url();?>admin/add_salaryy" id="sample_editable_1_new" class="btn orange">
																			<b>Add Salary [ <?=date('F Y');?> ] </b><i class="fa fa-plus"></i>
																			</a>
																			
																			<button type="submit" id="sample_editable_1_neww" class="btn green ik"> Bulk Salary <i class="glyphicon glyphicon-plus"></i></button>
