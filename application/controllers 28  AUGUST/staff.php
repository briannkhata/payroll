...
class Staff extends CI_Controller {
		...
		function taxband_add()
		{
			...
			$data['band1_rate'] = $this->input->post('band1_rate')/100;
		    $data['band2_rate'] = $this->input->post('band2_rate')/100;
		    $data['band3_rate']  = $this->input->post('band3_rate')/100;
		    $data['band4_rate']  = $this->input->post('band4_rate')/100;
			$data['month']  = $this->input->post('month');
			$data['year']  = $this->input->post('year');
			$insert = $this->crud_model->taxband_add($data);
			echo json_encode(array("status" => TRUE));
