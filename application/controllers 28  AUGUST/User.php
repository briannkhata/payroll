...
class User extends CI_Controller {
		...
		function lock()
		{
			$page_data['system']  	  = 'LabSoft';
			$page_data['page_title']  = 'System Lock';
			$this->load->view('lock',$page_data);	
		}
		...
		function pdf()
			{
				 ...
				 $html = $this->load->view('bills', true);
			...
			{
				$page_data['system']  	  = 'LabSoft';
				$page_data['page_title']  = 'Reservations';
				$this->load->view('reservations',$page_data);	 
			}
